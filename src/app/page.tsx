...
<section class="hero">
  ...
  <div class="container hero-content">
    ...
    <div class="hero-stats">
      <div class="stat-item">
        <div class="stat-num" style="font-size:22px;line-height:1.3;">End-to-end</div>
        <div class="stat-label">Billing, coding & follow-up</div>
      </div>
      <div class="stat-item">
        <div class="stat-num" style="font-size:22px;line-height:1.3;">BAA-ready</div>
        <div class="stat-label">HIPAA-conscious workflows</div>
      </div>
      <div class="stat-item">
        <div class="stat-num" style="font-size:22px;line-height:1.3;">Specialty-trained</div>
        <div class="stat-label">ICD-10 & CPT expertise</div>
      </div>
      <div class="stat-item">
        <div class="stat-num" style="font-size:22px;line-height:1.3;">No lock-in</div>
        <div class="stat-label">Month-to-month engagements</div>
      </div>
    </div>
  </div>
</section>
...
<div class="trust-bar">
  <div class="container trust-inner">
    <span class="trust-label">How we work</span>
    ...
    <div class="trust-badges">
      ...
      <div class="trust-badge">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M3 5h6M3 11h8" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>
        Transparent reporting
      </div>
      <div class="trust-badge">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 2a6 6 0 100 12A6 6 0 008 2zM8 5v3l2 2" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg>
...
<section id="results" style="background:var(--white);padding:100px 0;">
  <div class="container">
    <div class="section-header reveal" style="text-align:center;">
      <div class="tag" style="margin:0 auto 20px;">The Standard</div>
      <h2 class="section-title" style="text-align:center;">The benchmarks that<br/><em>define good RCM</em></h2>
      <p class="section-sub" style="margin:0 auto 20px;text-align:center;">These are published industry benchmarks — what well-run RCM operations consistently achieve. They're the targets we build every engagement around.</p>
      <p style="font-size:13px;color:var(--muted);text-align:center;margin-bottom:64px;font-style:italic;">Sources: MGMA, HFMA, CMS published data</p>
    </div>
    <div class="reveal" style="display:grid;grid-template-columns:repeat(3,1fr);gap:2px;background:rgba(11,22,40,.07);border-radius:var(--radius-lg) var(--radius-lg) 0 0;overflow:hidden;margin-bottom:2px;">
      <div style="background:var(--white);padding:48px 40px;">
        <div style="font-size:11px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:var(--muted);margin-bottom:16px;">Industry benchmark</div>
        <div style="font-family:var(--serif);font-size:52px;line-height:1;letter-spacing:-.03em;color:var(--navy);margin-bottom:10px;">&gt;95<span style="font-size:26px;color:var(--gold)">%</span></div>
        <div style="font-size:16px;font-weight:500;color:var(--navy);margin-bottom:8px;">Clean Claim Rate</div>
        <div style="font-size:14px;color:var(--muted);line-height:1.6;font-weight:300;">Top-performing billing operations submit over 95% of claims clean on first pass. The national average is closer to 75% — the gap is almost always coding and eligibility errors caught too late.</div>
      </div>
      <div style="background:var(--white);padding:48px 40px;">
        <div style="font-size:11px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:var(--muted);margin-bottom:16px;">Industry benchmark</div>
        <div style="font-family:var(--serif);font-size:52px;line-height:1;letter-spacing:-.03em;color:var(--navy);margin-bottom:10px;">&lt;30<span style="font-size:26px;color:var(--gold)">d</span></div>
        <div style="font-size:16px;font-weight:500;color:var(--navy);margin-bottom:8px;">Days in AR</div>
        <div style="font-size:14px;color:var(--muted);line-height:1.6;font-weight:300;">MGMA benchmarks healthy AR at under 30 days. Practices with aging AR above 50 days are typically losing revenue to timely filing limits and payer inaction.</div>
      </div>
      <div style="background:var(--white);padding:48px 40px;">
        <div style="font-size:11px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:var(--muted);margin-bottom:16px;">Industry benchmark</div>
        <div style="font-family:var(--serif);font-size:52px;line-height:1;letter-spacing:-.03em;color:var(--navy);margin-bottom:10px;">&lt;5<span style="font-size:26px;color:var(--gold)">%</span></div>
        <div style="font-size:16px;font-weight:500;color:var(--navy);margin-bottom:8px;">Denial Rate</div>
        <div style="font-size:14px;color:var(--muted);line-height:1.6;font-weight:300;">HFMA benchmarks an acceptable denial rate below 5%. The national average sits at 9% — and most of those denials are preventable with the right front-end process.</div>
      </div>
    </div>
    <div class="reveal" style="background:var(--navy);border-radius:0 0 var(--radius-lg) var(--radius-lg);overflow:hidden;padding:44px 40px;display:grid;grid-template-columns:1fr 1fr 1fr;gap:40px;align-items:center;">
      <div style="grid-column:1/3;">
        <div style="font-size:11px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:var(--gold);margin-bottom:14px;">Our commitment</div>
        <div style="font-family:var(--serif);font-size:24px;color:var(--white);line-height:1.3;letter-spacing:-.015em;margin-bottom:12px;">We build your engagement around these benchmarks — and we show you the numbers every month.</div>
        <div style="font-size:14px;font-weight:300;color:rgba(250,250,248,.5);line-height:1.65;">No hiding behind averages. Every client receives a monthly report with clean claim rate, denial rate, days in AR, and collection rate — benchmarked against industry standards so you always know where you stand.</div>
      </div>
      <div style="display:flex;flex-direction:column;gap:14px;">
        <div style="display:flex;align-items:center;gap:12px;padding:14px 18px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);border-radius:var(--radius);">
          <div style="width:8px;height:8px;border-radius:50%;background:var(--gold);flex-shrink:0;"></div>
          <span style="font-size:14px;color:rgba(250,250,248,.75);">Monthly KPI report, every client</span>
        </div>
        <div style="display:flex;align-items:center;gap:12px;padding:14px 18px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);border-radius:var(--radius);">
          <div style="width:8px;height:8px;border-radius:50%;background:var(--gold);flex-shrink:0;"></div>
          <span style="font-size:14px;color:rgba(250,250,248,.75);">Denial root-cause breakdown</span>
        </div>
        <div style="display:flex;align-items:center;gap:12px;padding:14px 18px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);border-radius:var(--radius);">
          <div style="width:8px;height:8px;border-radius:50%;background:var(--gold);flex-shrink:0;"></div>
          <span style="font-size:14px;color:rgba(250,250,248,.75);">AR aging by payer, every month</span>
        </div>
        <div style="display:flex;align-items:center;gap:12px;padding:14px 18px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);border-radius:var(--radius);">
          <div style="width:8px;height:8px;border-radius:50%;background:var(--gold);flex-shrink:0;"></div>
          <span style="font-size:14px;color:rgba(250,250,248,.75);">Benchmarked against MGMA & HFMA</span>
        </div>
      </div>
    </div>
  </div>
